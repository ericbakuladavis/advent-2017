...
const cluster = {
    ...
    cleanOrInfect(){
        switch (this.currentNode){
            case '.':   this.currentNode = 'W';
                        break;
            case '#':   this.currentNode = 'F';
                        break;
            case 'W':   this.currentNode = '#';
                        this.infectCount++;
                        break;
            case 'F':   this.currentNode = '.';
                        break;
        }
    },
...
cluster.setMap(input);
cluster.go(10000000);
console.log(cluster.infectCount); // 2512599